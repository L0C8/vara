...
- Ladders: vertical climbable surface; direction vector; climb speed; collider blocks passthrough unless flagged open. This block will effectively allow the player to move up and down on the z axis when touching a wall
