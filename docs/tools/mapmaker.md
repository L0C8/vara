...
- Materials: per-surface/material id assignments; names match game material table.
...
- Entities: placements for spawn points, enemies (with params), items, key doors, exits.
...
## Tech Notes
- Built with raylib for UI rendering and input; uses same math types as the game to reduce conversion issues.
